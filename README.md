...
![img5](img/img5.png)
	...
	systemctl status zabbix-agentg 
	nano /var/log/zabbix/zabbix_agentd.log  

	ssh-keygen
	cat /home/user/.ssh/id_ed25519.pub
	git clone git@github.com:KuznetsovIS/zabbix-monitor-homework.git
	cd zabbix-monitor-homework
	ls -a
	git config user.name "Кузнецов Иван"
	git config user.email ivankuz@mail.ru
	git status 
	nano README.md 
	git add .
	git commit -m 'task1'
